...
//  unsigned char buffer[updateServerString.length()];
//  memcpy(buffer, updateServerString, updateServerString.length());

//  int count = strcpy(buf, text.c_str());
...
//  }
  ...
  while ( bleuart.available() )
  {
    ...
    DeserializationError err = deserializeJson(receiveFromServerDoc, ch);
    Serial.println(ch);
    sendState();
  }
}
